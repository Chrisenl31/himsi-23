...
@section('content')
    ...
    <div class="about--tentang">
        ...
        <h4 class="grey">HIMSI UNAIR berdiri sejak <span class="midnight-blue">26 November 2015</span>, dan pada
            tahun ketujuh ini menggunakan nama kabinet <span class="midnight-blue">Mercusuar</span>. Menara yang dibangun di
            pantai, pulau kecil
            di tengah laut, daerah berbatu karang, dan sebagainya, yang memancarkan sinar isyarat pada waktu malam hari
            untuk
            membantu navigasi. Seperti arti namanya, Kabinet <span class= "midnight-blue">Mercusuar</span> ingin menjadi
            sebuah menara yang tinggi <span class = "gold">(Dikenal)</span> ,
            dengan fondasi yang kokoh <span class = "gold">(Kekeluargaan)</span>, serta membawa cahaya yang terang <span
