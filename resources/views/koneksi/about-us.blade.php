...
@section('content')
    <div class="about--header">
        <img src="{{ url('assets\image\kalibraksi\logo-kalibraksi-notitle-1.jpg') }}" alt=""
            class="about--header__ornament" style="transform: scale(0.8); margin-top:90px">
        <div class="about--header__content">
            <span class="about--header__koneksi midnight-blue">KALIBRAKSI</span>
            <h4 class="about--header__spelling grey">/KA • LI • BRAK • SI/</h4>
            <h3 class="about--header__relation grey">Kalibrasi, Kolaborasi, Kontribusi</h3>
        </div>
    </div>
    ...
    <div class="about--tentang">
        ...
        <h4 class="grey">HIMSI UNAIR berdiri sejak <span class="midnight-blue">26 November 2015</span>, dan pada
            tahun kedelapan ini menggunakan nama kabinet <span class="midnight-blue">Kalibraksi</span>. Menara yang dibangun di
            pantai, pulau kecil di tengah laut, daerah berbatu karang, dan sebagainya, yang memancarkan sinar isyarat pada
            waktu malam hari
            untuk membantu navigasi. Seperti arti namanya, Kabinet <span class= "midnight-blue">Mercusuar</span> ingin
            menjadi
            sebuah menara yang tinggi <span class = "gold">(Dikenal)</span> , dengan fondasi yang kokoh <span
                class = "gold">(Kekeluargaan)</span>, serta membawa cahaya yang terang <span
                class = "gold">(Berdampak)</span>.
    </div>
    ...
    <div class="about--bidang">
        ...
        <div class="about--bidang__cards">
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/BPH.svg') }}" alt="BPH" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/Akademik.svg') }}" alt="Akademik" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/Ristek.svg') }}" alt="Ristek" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/Media.svg') }}" alt="Media" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/Sera.svg') }}" alt="Sera" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/Hublu.svg') }}" alt="Hublu" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/Kestari.svg') }}" alt="Kestari" class="about--bidang__card-img"
                    width="60px">
            ...
            <div class="about--bidang__card">
                <img src="{{ url('assets/img/mercusuar/PSDM.svg') }}" alt="PSDM" class="about--bidang__card-img"
                    width="60px">
